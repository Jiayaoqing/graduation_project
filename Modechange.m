function varargout = Modechange(varargin)
% MODECHANGE MATLAB code for Modechange.fig
%      MODECHANGE, by itself, creates a new MODECHANGE or raises the existing
%      singleton*.
%
%      H = MODECHANGE returns the handle to a new MODECHANGE or the handle to
%      the existing singleton*.
%
%      MODECHANGE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MODECHANGE.M with the given input arguments.
%
%      MODECHANGE('Property','Value',...) creates a new MODECHANGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Modechange_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Modechange_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Modechange

% Last Modified by GUIDE v2.5 12-Jun-2018 14:13:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Modechange_OpeningFcn, ...
                   'gui_OutputFcn',  @Modechange_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Modechange is made visible.
function Modechange_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Modechange (see VARARGIN)

% Choose default command line output for Modechange
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Modechange wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Modechange_OutputFcn(hObject, eventdata, handles) 
