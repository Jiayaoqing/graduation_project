...
for i=1:5
    ...
    %             [ PSNR,MSE ] = Psnr(blocks_I{a4,a3}(:,ww),forecast{a4,a3}(:,ww));
    %             MSE_V_16x16(a4,a3)=MSE;
    % [ma, inda] = min(MSE_V_16x16(:,2));
    % [r, c] = ind2sub(size(MSE_V_16x16), inda)
    %         end
    %     end
    % [ma, inda] = min(MSE_V_16x16(:,2));
    % [r, c] = ind2sub(size(MSE_V_16x16), inda);
    xlswrite('MSE_V_16x16_50.xls',MSE_V_16x16_50);
