function pie_16_chart_50()
% clear all;
H = xlsread('F:\graduation_project\MSE_H_16x16_50.xls');
V = xlsread('F:\graduation_project\MSE_V_16x16_50.xls');
O = xlsread('F:\graduation_project\MSE_O_16x16_50.xls');
[min1]=min_AB(H,V);
[min]=min_AB(O,min1);
...
[i1,j1] = find(strcmp(HH_50, 'mode_H'));
mode_H_number=length(i1);
[i2,j2] = find(strcmp(VV_50, 'mode_V'));
mode_V_number=length(i2);
[i3,j3] = find(strcmp(OO_50, 'mode_O'));
